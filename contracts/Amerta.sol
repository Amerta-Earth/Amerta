...
contract Amerta is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xAF68fA7e530da47d2453E5E3d6ab59Dc4DE120E3); // Marketing Address
    ...
    string private _name = "AMERTA";
    string private _symbol = "AMRT";
